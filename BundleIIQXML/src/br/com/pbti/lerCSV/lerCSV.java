...
public class lerCSV extends MontarXml {
	 ...
	 * 
	 * 
	 * static String codSistema; static String codPerfil; static String
	 * tipoUnidade; static String funcao; static String codFuncao; static String
	 * codUnidade; static String tipoUsu; static String codCargo; static String
	 * indUnidade;
	 * 
	 * static String COD_SISTEMA; static String COD_PERFIL; static String
	 * UG_NAME; static String RSS_NAME; static String FUNCIONALIDADE; static
	 * String STATUS; static String COD_RESTRICAO; static String QUANTIDADE;
	...
	// public static void testeCriarXML() throws FileNotFoundException,
	...
	public static ArrayList<String> teste2 = new ArrayList<String>();
	public static ArrayList<String> teste1 = new ArrayList<String>();

	@SuppressWarnings("resource")
	public static void lerMIP04() throws FileNotFoundException,
			ParserConfigurationException, TransformerFactoryConfigurationError,
			TransformerException {
		Scanner scannerMip04 = new Scanner(
				new FileReader(
	...
	public static ArrayList<String> collection3 = new ArrayList<String>();
	...
	public static void lerMIP06() throws FileNotFoundException,
		...
		Scanner scannerMIP06 = new Scanner(
				new FileReader(
			...
			if (teste1.size() != 0) {
				if (recebePalavraSeparados.size() != 0) {
					if ((teste1.get(0).equals(recebePalavraSeparados.get(0)))) {
						if (teste1.get(2).equals(recebePalavraSeparados.get(2))
								&& (teste1.get(1).equals(recebePalavraSeparados
										.get(1)))
								&& (teste1.get(2).equals(recebePalavraSeparados
										.get(2)))
								&& (teste1.get(3).equals(recebePalavraSeparados
										.get(3)))
								&& (teste1.get(5).equals(recebePalavraSeparados
										.get(5)))
								&& (teste1.get(6).equals(recebePalavraSeparados
										.get(6)))
								&& (teste1.get(7).equals(recebePalavraSeparados
										.get(7)))
								&& (teste1.get(8).equals(recebePalavraSeparados
										.get(8)))
								&& (!teste1.get(4).equals(
										recebePalavraSeparados.get(4)))) {
							...
							coSistemaMIP06 = teste1.get(0);
							coPerfilMIP06 = teste1.get(1);
							tipoUnidadeMIP06 = teste1.get(2);
							funcaoMIP06 = teste1.get(3);
							// codFuncaoMPI06 = recebePalavraSeparados.get(4);
							codUnidadeMIP06 = teste1.get(5);
							tipoUsuarioMIP06 = teste1.get(6);
							codCargoMIP06 = teste1.get(7);
							indUnidadeMIP06 = teste1.get(8);
...
//					}
	...
	public static void tratamentoPassagem() throws FileNotFoundException,
			ParserConfigurationException, TransformerFactoryConfigurationError,
			TransformerException {
		ArrayList<String> teste = new ArrayList<String>();
		System.out.println(collection2);

		if (coSistemaMIP04.equals(coSistemaMIP06)
				&& coPerfilMIP04.equals(coPerfilMIP06)) {
			setNomeXml(coSistemaMIP06 + "_" + coPerfilMIP06);
			bundle.setNomeBundle(coSistemaMIP06 + "_" + coPerfilMIP06);
			inheritance.setInheritanceName(coSistemaMIP06);
			owner.setOwnerName("spadmin");
			profiles.setApplicatonRefName(rssTypeMIP04);
			profiles.setConstraintsListString(ugNameMIP04);
			cabecalho();
