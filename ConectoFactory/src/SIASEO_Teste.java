 ...
 */
public class SIASEO_Teste extends AbstractConnector {
	...
	public String coUsuario = "CO_USUARIO"; // used as nativeIdentityAttribute
	...
	public String sisPerfil = "SIS_PERFIL"; // used as nativeIdentityAttribute
	 ...
	 *            The Log to use.
	 */
	public SIASEO_Teste(ConnectorConfig config, openconnector.Log log)
			throws Exception {
		super(config, log);
		m_bIsDriverLoaded = false;
		it = null;
	...
	public Iterator<Map<String, Object>> iterate(Filter filterArg)
	...
	public Result create(String nativeIdentifier, List<Item> items)
		...
		try {
			...
			result.add("CO_SISTEMA: " +codSistema+ " CO_USUARIO: "+codUsuario+" NUM_PERFIL: "+numPerfil+" PASSWORD: " +passwordLimpo);
			if (log.isDebugEnabled())
...
//			alterarStatus(codUsuario, IC_STATUS_USUARIO_LOCK);
	...
	public Result setPassword(String nativeIdentifier, String newPassword,
		...
		String codUsuario = "", clearPassword= "";
	...
	public Iterator<Map<String, Object>> getAccounts(String filter) {
		...
		try {
			...
			while (queryResult.next()) {
				...
				log.debug("NO_USUARIO " + queryResult.getString("NO_USUARIO"));
				...
				log.debug("noUsuario " + queryResult.getString("NO_USUARIO"));
				log.debug("icStatus " + queryResult.getString("IC_STATUS"));
				log.debug("icTipo " + queryResult.getString("IC_TIPO"));
	...
	public void createConnection(String coSistema, String coUsuario, String nuPerfil) {
	...
	public void deletarConnectionUsuario(String coSistema, String coUsuario, String nuPerfil)
	{
		Result result = new Result();
...
//	private void alterarStatus(String coUsuario, String icStatus)
//	{
//		Result result = new Result();
//		
//		try {
...
//	}
	...
	private void alterarSenha(String coUsuario, String senhaLimpa) 
	{
		...
		log.debug("Procedure Alterar Senha " + "CodUsuario " + coUsuario+" Senha "+senhaLimpa);
